...
export default function Contact() {
    ...
    const handleUpdate = async (e: FormEvent) => {
        ...
        if (error) {
            ...
            alert('Your message was successfully updated for our Team.');
            resetForm();
        }
    };
                        ...
                        <div className="flex justify-center">
                            <div className="text-center md:text-center lg:text-start">
                                ...
                                <div className="mt-5">
                                    ...
                                    <ul className="list-none flex gap-6 border mt-4 rounded-lg bg-[#F5F7F8] p-2 md:p-4 lg:p-2">
                                        ...
                                        <Link href="https://www.instagram.com/mr._bhanu_03/" target="_blank"><li className="p-2 rounded-full bg-white"><BsInstagram size={30} className="text-[#FD0ADE]" /></li></Link>
